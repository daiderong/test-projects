...
public class Read_YBDMRSBBMDZB_Excel {

	public static void main(String args[]) {
		try {

			String fileName = "标准库药品导入_线上购药AND高婷_0630";//不用后缀，必须是xls
			...
			for (int i = start; i < end; i++) {
				String insertSQL = "INSERT INTO temp_YBDMRSBBMDZB(" + cloumnNameStr + ") VALUES(";
