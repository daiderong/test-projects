...
//            }
     ...
     * 
     * */
    public static String sendPostWithObjectJson(String url, String json ) throws Exception {
...
//         System.out.println(conn.getResponseCode()); //响应代码 200表示成功
    ...
    public static void main(String[] args) throws Exception {
    	long stat = System.currentTimeMillis();
			...
			System.out.println(sendPost("http://www.guabu.com/bank/","cardid=9558821001001829004"));
